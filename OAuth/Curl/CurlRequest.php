<?php
	...
	class CurlRequest {
		...
		public function getResponse() {
			...
			// ajout de l'header dans la reponse
			...
			$header = $this->http_parse_headers(substr($result, 0, $header_size));
			...
			if ($curl_error) {
				...
				$body = (null === $json_decode) ? $body : $json_decode;
			}
			curl_close($ch);

			return new CurlResponse($curlInfo, $header, $body);
		}
